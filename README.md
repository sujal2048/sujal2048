...
I am currently contributing Professionally in BACKEND projects in JAVA and  GOLANG and learning the core logic behind DISTRIBUTED SYSTEM.
Proficient in Java ,Python, GoLang and C++ with strong command in Spring Boot, microservices, REST/gRPC APIs and distributed systems, Apache Kafka, and Open Telemetry.
Hands on Experience with AWS  .Experience with AI/ML and LLM-backed platforms, including TensorFlow,  RAG pipelines, vector databases and LLM orchestration (GPT, Claude, Llama, LangChain, LiteLLM). Focused on system design, observability and production services that handle real-time, large-scale workloads
...
<img alt="GoLang" width="40px" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/go/go-original.svg" />
    ...
    <img alt="Kubernetes" width="40px" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/kubernetes/kubernetes-plain.svg" />
